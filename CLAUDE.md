...
10. **Mini modules** - Icons, tabline, statusline, clue (which-key style hints), neo-tree (sidebar file explorer, depends on nui.nvim and plenary.nvim), pick, diff (with git signs and hunk navigation), completion, pairs, surround, splitjoin, sessions
